<?php   
namespace service;
//define('__QQWRY__' , dirname(__FILE__)."/data/QQWry.Dat");  
...
class QQWry{ 
    ...
    function qqwry ($dotip='') { 
     ...
     fclose ( $this->fp ); 
$this->Country= iconv("gbk","UTF-8//TRANSLIT",preg_replace("/(CZ88.NET)|(纯真网络)/","",$this->Country));
$this->Local=iconv("gbk","UTF-8//TRANSLIT",preg_replace("/(CZ88.NET)|(纯真网络)/","",$this->Local)); 
